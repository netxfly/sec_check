...
# CGO_ENABLED=1 go build --tags yara_static --tags no_pkg_config --tags yara3.7 main.go

#Linux下编译出不依赖任何库的可执行文件，大小为13M
# CGO_ENABLED=1 go build --ldflags '-extldflags "-static -lm"' --tags yara_static --tags no_pkg_config --tags yara3.7 main.go
